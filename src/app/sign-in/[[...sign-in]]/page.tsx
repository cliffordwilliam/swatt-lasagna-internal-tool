            ...
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>
                      Sign in ke Swatt Lasagna Internal Tool
                    </CardTitle>
                    <CardDescription>
              ...
              <SignIn.Step name="choose-strategy">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>Gunakan metode lain</CardTitle>
                    <CardDescription>
                      Mengalami masalah? Anda bisa menggunakan salah satu metode
                      ini untuk masuk.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-y-4">
              ...
              <SignIn.Step name="verifications">
                <SignIn.Strategy name="password">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      <CardTitle>Masukan Kata Sandi</CardTitle>
                      <CardDescription>
                        Selamat datang kembali <SignIn.SafeIdentifier />
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
